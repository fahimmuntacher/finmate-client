          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border rounded-lg px-3 py-2 dark:bg-neutral-900 dark:border-green-500  dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500"
              >
